...
__decorate([
    ...
    swagger_1.ApiOperation({ summary: 'Restart / reboot the host server.' }),
    common_1.Put('restart-host'),
...
__decorate([
    common_1.UseGuards(admin_guard_1.AdminGuard),
    swagger_1.ApiOperation({ summary: 'Shutdown / power off the host server.' }),
    common_1.Put('shutdown-host'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], LinuxController.prototype, "shutdownHost", null);
LinuxController = __decorate([
    swagger_1.ApiTags('Platform - Linux'),
    swagger_1.ApiBearerAuth(),
    common_1.UseGuards(passport_1.AuthGuard()),
    common_1.Controller('platform-tools/linux'),
