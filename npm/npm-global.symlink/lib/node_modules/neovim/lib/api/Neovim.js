...
class Neovim extends Base_1.BaseApi {
     ...
     */
    openWin(buffer, enter, width, height, options) {
     ...
     */
    openWindow(buffer, enter, width, height, options) {
     ...
     * @Param {Object}  options Options object
     */
    winConfig(window, width, height, options = {}) {
        return window.config(width, height, options);
    }
    /**
     * Public Alias for `winConfig`
     */
    windowConfig(window, width, height, options = {}) {
