...
export declare class Neovim extends BaseApi {
    ...
    */
     ...
     */
    openWindow(buffer: Buffer, enter: boolean, width: number, height: number, options: OpenWindowOptions): Promise<Window | number>;
    /**
     ...
     */
    windowConfig(window: Window, width: number, height: number, options?: object): Promise<any>;
    /**
     * Closes window
     *
