...
__decorate([
    ...
    swagger_1.ApiOperation({ summary: 'Return the startup flags and env variables for Homebridge.' }),
    common_1.Get('homebridge-startup-settings'),
...
__decorate([
    common_1.UseGuards(admin_guard_1.AdminGuard),
    swagger_1.ApiOperation({ summary: 'Update the startup flags and env variables for Homebridge.' }),
    common_1.Put('homebridge-startup-settings'),
...
__decorate([
    ...
    common_1.Put('set-full-service-restart-flag'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
...
__decorate([
    common_1.UseGuards(admin_guard_1.AdminGuard),
    swagger_1.ApiOperation({ summary: 'Download the entire log file.' }),
    common_1.Get('log/download'),
    swagger_1.ApiQuery({ name: 'colour', enum: ['yes', 'no'], required: false }),
    __param(0, common_1.Query('colour')),
    __metadata("design:type", Function),
...
__decorate([
    common_1.UseGuards(admin_guard_1.AdminGuard),
    swagger_1.ApiOperation({ summary: 'Truncate / empty the log file.' }),
    common_1.Put('log/truncate'),
...
HbServiceController = __decorate([
    swagger_1.ApiTags('Platform - HB Service'),
    swagger_1.ApiBearerAuth(),
    common_1.UseGuards(passport_1.AuthGuard()),
    common_1.Controller('platform-tools/hb-service'),
