...
__decorate([
    common_1.Get('/:pluginName/*'),
    swagger_1.ApiOperation({ summary: 'Returns the HTML assets for a plugin\'s custom UI' }),
    swagger_1.ApiParam({ name: 'pluginName', type: 'string' }),
    __param(0, common_1.Res()), __param(1, common_1.Param('pluginName')), __param(2, common_1.Param('*')), __param(3, common_1.Query('origin')),
...
PluginsSettingsUiController = __decorate([
    swagger_1.ApiTags('Plugins'),
    common_1.Controller('plugins/settings-ui'),
