...
__decorate([
    ...
    __param(0, common_1.Param('uniqueId')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    swagger_1.ApiParam({ name: 'uniqueId' }),
    common_1.Put('/:uniqueId'),
    __param(0, common_1.Param('uniqueId')), __param(1, common_1.Body()),
    __metadata("design:type", Function),
